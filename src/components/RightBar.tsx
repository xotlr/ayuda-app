    ...
    <>
      <aside className="sticky top-0 hidden w-96 flex-col gap-6 self-start sm:flex">
        <article className="my-6 flex justify-between gap-4">
          <div
            className="relative flex cursor-default items-center gap-2 rounded-xl p-3 font-bold uppercase text-muted-foreground hover:bg-gray-100"
...
const DailyQuestsSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200/10 bg-muted p-6 font-bold text-muted-foreground">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center">
            <div className="relative h-5 w-52 rounded-l-full bg-gray-200/50">
              <div
                className={[
      ...
      <div className="flex gap-5">
        ...
        <div className="flex grow flex-col justify-around">
          ...
          <div className="flex items-center gap-5">
            <div className="relative h-4 w-full grow rounded-full bg-gray-200/50">
              {xpToday > 0 && (
                <div
...
const CreateAProfileSection = ({
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200/10 bg-muted p-6 font-bold">

...
export const LoginScreen = ({
  ...
  return (
    <article
      className={[
        "fixed inset-0 z-30 flex flex-col bg-background p-7 transition duration-300",
    ...
    >
      <header className="flex flex-row-reverse justify-between sm:flex-row">
        ...
        <button
          className="hidden rounded-2xl border-2 border-b-4 border-muted-foreground px-4 py-3 text-sm font-bold uppercase bg-primary text-primary-foreground transition sm:block"
          onClick={() =>
      ...
      <div className="flex grow items-center justify-center">
        <div className="flex w-full flex-col gap-5 sm:w-96">
            ...
            {loginScreenState === "SIGNUP" && (
              <>
                <div className="relative flex grow">
                  <input
                    className="grow rounded-2xl border-2 border-gray-200/10 bg-muted px-4 py-3"
                    placeholder="Age (optional)"
                  />
                  <div className="absolute bottom-0 right-0 top-0 flex items-center justify-center pr-4">
                    <div
                      className="relative flex h-6 w-6 cursor-pointer items-center justify-center rounded-full border-2 border-gray-200/10 bg-muted text-muted-foreground"
                    ...
                    >
                      ?
                      {ageTooltipShown && (
                        <div className="absolute -right-5 top-full z-10 w-72 rounded-2xl border-2 border-gray-200/10 bg-muted p-4 text-center text-xs leading-5 text-foreground">
          ...
          <div className="flex items-center gap-2">
            <div className="h-[2px] grow border-gray-200/10 bg-muted"></div>
            <span className="font-bold uppercase text-muted-foreground">or</span>
            <div className="h-[2px] grow border-gray-200/10 bg-muted"></div>
          </div>
          <div className="flex gap-5">
            <button
              className="flex w-full items-center justify-center gap-2 rounded-2xl border-2 border-b-4 border-gray-200/10 bg-muted py-3 font-bold text-muted-foreground transition hover:bg-muted hover:brightness-90"
              onClick={logInAndSetUserProperties}
            >

          ...
          <div className="py-7">
            ...
            <div className="flex border-t-2 border-gray-300 py-5">
              ...
              <section className="flex flex-col gap-3">
                ...
                <div className="w-fit rounded-full bg-muted px-3 py-1 text-sm font-bold uppercase text-muted-foreground">
                  {streakFreezes} / 2 equipped
                </div>
                <button
                  className="flex w-fit items-center gap-1 rounded-2xl border-2 border-gray-200/10 bg-muted px-4 py-2 text-sm font-bold uppercase text-muted-foreground"
                  disabled
                >
            ...
            <div className="flex border-t-2 border-gray-200/10 py-5">
          ...
          <div className="py-7">
            ...
            <div className="flex border-t-2 border-gray-300 py-5">
              ...
              <section className="flex flex-col gap-3">
                ...
                <button className="flex w-fit items-center gap-1 rounded-2xl border-2 border-b-4 border-gray-200/10 bg-muted px-4 py-3 text-sm font-bold uppercase text-red-500">
                  $29.99
                </button>
              </section>
            </div>

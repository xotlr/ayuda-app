...
const getTileColors = ({
  ...
  switch (status) {
    case "LOCKED":
      ...
      return "border-gray-200/10 bg-muted";
    case "COMPLETE":
  ...
  return (
    ...
    >
      <div
        className={[
          ...
          status === "ACTIVE"
            ...
            : status === "LOCKED"
              ? "border-2 border-gray-200/10 bg-muted"
              : "bg-yellow-400",
      ...
      >
        <div
          className={[
            ...
            status === "ACTIVE"
              ? activeBackgroundColor
              : status === "LOCKED"
                ? "border-l-2 border-t-2 border-gray-200/10 bg-muted"
                : "bg-yellow-400",
          ].join(" ")}
          style={{
        ...
        {status === "ACTIVE" ? (
          <Link
            href={`/lesson?unit=${unitNumber}&lesson=${index}`}
            className={[
              "flex w-full items-center justify-center rounded-xl border-b-4 border-gray-200/10 bg-muted hover:bg-primary p-3 uppercase",
              activeTextColor,
            ].join(" ")}
          >
            Start +10 XP
          ...
          <button
            className="w-full rounded-xl border-gray-200/10 bg-muted p-3 uppercase text-muted"
            disabled
          >
            Locked
          </button>
          ...
          <Link
            href={`/lesson?unit=${unitNumber}&lesson=${index}`}
            className="flex w-full items-center justify-center rounded-xl border-b-4 border-yellow-200 border-gray-200/10 bg-muted p-3 uppercase text-yellow-400"
          >
            Practice +5 XP
          </Link>
        )}
        ...
        <div className="flex max-w-2xl grow flex-col">
          ...
          <div className="sticky bottom-28 left-0 right-0 flex items-end justify-between">
            <Link
              ...
              className="absolute left-4 flex h-16 w-16 items-center justify-center rounded-full border-2 border-b-4 border-gray-200/10 bg-muted transition hover:bg-primary hover:brightness-90 md:left-0"
            >
            ...
            {scrollY > 100 && (
              <button
                className="absolute right-4 flex h-14 w-14 items-center justify-center self-end rounded-2xl border-2 border-b-4 border-gray-200/10 bg-muted transition hover:bg-primary hover:brightness-90 md:right-0"
...
const HoverLabel = ({
  ...
  return (
    <div
      className={`absolute z-10 w-max animate-bounce rounded-lg border-2 border-gray-200/10 bg-muted px-3 py-2 font-bold uppercase ${textColor}`}
      style={{
        top: "-25%",
    ...
    >
      {text}
      <div
        className="absolute h-3 w-3 rotate-45 border-b-2 border-r-2 border-gray-200/10 bg-muted"
    ...
    >
      <header className="flex items-center justify-between gap-4 p-4">
        ...
        <Link
          ...
          className={[
            "flex items-center gap-3 rounded-2xl border-2 border-b-4 p-3 transition",
            borderColor,
          ].join(" ")}
        >
          <GuidebookSvg />
